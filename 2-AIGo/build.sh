...
do
    ...
    black_tie=0
    white_tie=0
    for (( round=1; round<=$play_time; round+=1 )) 
    do
        # # TA takes Black
        # echo "=====Round $round====="
    ...
    echo =====Summary=====  
    echo "You play as Black Player | Win: $black_win_time | Lose: $((play_time-black_win_time-black_tie)) | Tie: $black_tie"
    # echo "You play as White Player | Win: $white_win_time | Lose: $((play_time-white_win_time-black_tie)) | Tie: $white_tie"
done
